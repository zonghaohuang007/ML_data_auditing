...
def getCifarTransform(name, img_size=40, crop_size=32, as_list=False, normalization=True):
    ...
    if name == "random":
        transform = [
            transforms.RandomCrop(crop_size, padding=padding, padding_mode='reflect'), 
...
def get_data_loader(params, transform, shuffle, distributed_sampler, root, watermark_path=""):
    """
