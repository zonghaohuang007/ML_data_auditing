...
def finetune(args):
    ...
    train_set = torchvision.datasets.ImageFolder(root='./data/cifar100/train/', transform=train_transform)
    ...
    test_set = torchvision.datasets.ImageFolder(root='./data/cifar100/test/', transform=test_transform)
...
def get_parser():
    ...
    parser.add_argument('--unpublished_path', type=str, default='./data/cifar100/')
    ...
    parser.add_argument('--train_path', type=str, default='./data/cifar100/')
...
def train(args):
    ...
    train_transform = transforms.Compose([transforms.RandomResizedCrop(32),
                                          ...
                                          transforms.ToTensor(),
                                          transforms.Normalize(mean=[0.5071598291397095, 0.4866936206817627, 0.44120192527770996], std=[0.2673342823982239, 0.2564384639263153, 0.2761504650115967])
                                          ])
...
def detection(transform, sample_list, args):
    ...
    augmentation = transforms.Compose([transforms.RandomResizedCrop(32,(0.8, 1.0)),
                                        transforms.RandomHorizontalFlip(p=0.5),
                                        ])
...
if __name__ == '__main__':
    ...
    # detect the encoder
    args.image_mean = [0.5071598291397095, 0.4866936206817627, 0.44120192527770996]
    args.image_std = [0.2673342823982239, 0.2564384639263153, 0.2761504650115967]
