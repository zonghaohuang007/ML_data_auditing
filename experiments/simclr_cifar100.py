...
def finetune(args):
    ...
    train_set = torchvision.datasets.ImageFolder(root='./experiments/data/cifar100/train/', transform=train_transform)
    ...
    test_set = torchvision.datasets.ImageFolder(root='./experiments/data/cifar100/test/', transform=test_transform)
