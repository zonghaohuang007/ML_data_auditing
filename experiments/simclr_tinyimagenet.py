...
def finetune(args):
    ...
    train_set = torchvision.datasets.ImageFolder(root='./data/tinyimagenet/train/', transform=train_transform)
    ...
    test_set = torchvision.datasets.ImageFolder(root='./data/tinyimagenet/test/', transform=test_transform)
...
def get_parser():
    ...
    # main parameters
    parser.add_argument('--img_path', type=str, default='./data/tinyimagenet/train/')
    parser.add_argument('--published_path', type=str, default='./data/tinyimagenet/')
    parser.add_argument('--unpublished_path', type=str, default='./data/tinyimagenet/')
    ...
    parser.add_argument('--train_path', type=str, default='./data/tinyimagenet/')
